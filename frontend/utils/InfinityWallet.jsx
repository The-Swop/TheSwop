...
export function InfinityWallet() {
  ...
  const grabBalance = async() => {
    ...
    const res = await window.ic.infinityWallet.requestBalance();
  ...
  const manageLogin = async() => {
    ...
    userPrincipal = await window.ic.infinityWallet.getPrincipal();
  ...
  return (
    <>
      <div className="walletContainer">
        <button onClick={dropTheMenu} id='plugMenu' className='plugMenu'>Infinity Menu<div className='statusBubble' id='statusBubble'></div></button>
